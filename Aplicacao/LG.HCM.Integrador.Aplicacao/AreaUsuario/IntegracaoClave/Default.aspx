<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LG.HCM.Integrador.Aplicacao.Profile.Simplifica.IntegracaoClave" %>
    ...
    <div class="p-grid">
        ...
        <script>
			...
			const App = {
                ...
                methods: {
					openUrl(value) {
                        window.open("<% = HttpContext.Current.Application["UrlSI"].ToString() %>Modulos/LG.HCM.Integrador/Integracoes/Clave/SSO.aspx?tipo-conteudo=Home");
				    },
                },
			};
