...
namespace LG.HCM.Integrador.Aplicacao.Administracao.ConfiguracoesGerais.Clave.Servicos {
	/// <summary>
	/// Summary description for ConfigurarProfile
	/// </summary>
	public class ConfiguracaoIntegracao : ServicoBaseCadastro {
		public const string ID_PARAMETRO_CONFIGURACAO_ENVIO_DADOS_CORPORATIVOS = Classes.Parametros.ID_CONFIGURACAO_ENVIO_DADOS_CORPORATIVOS_CLAVE;
		public const string ID_PARAMETRO_CONFIGURACAO_URL_BASE_API = Classes.Parametros.ID_CONFIGURACAO_URL_BASE_API_CLAVE;
		public const string ID_PARAMETRO_CONFIGURACAO_TOKEN_CLIENT_SECRET = Classes.Parametros.ID_CONFIGURACAO_TOKEN_CLIENT_SECRET_CLAVE;

		public const string ID_CAMPO_CONFIGURACAO_ENVIO_DADOS_CORPORATIVOS = "IntegracaoClaveEnvioDadosCorporativos";
		public const string ID_CAMPO_CONFIGURACAO_URL_BASE_API = "IntegracaoClaveUrlBase";
		public const string ID_CAMPO_CONFIGURACAO_TOKEN_CLIENT_SECRET = "IntegracaoClaveChave";
